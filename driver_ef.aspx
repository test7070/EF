	...
	<head>
		...
		<script type="text/javascript">
            ...
            function mainPost() {
            	...
            	q_cmbParse("cmbGuild"," ,模組一,模組二,模組三");
            ...
            function _btnSeek() {
                ...
                q_box('driver_ef_s.aspx', q_name + '_s', "550px", "400px", q_getMsg("popSeek"));
            }
            ...
            function btnPrint() {
				q_box('z_driverp_ef.aspx' + "?;;;;" + r_accy, '', "95%", "95%", q_getMsg("popPrint"));
            }
			function q_stPost() {
                if (!(q_cur == 1 || q_cur == 2))
                    return false;
			...
			<div class="dbbm">
				<table class="tbbm"  id="tbbm">
					...
					<tr>
						...
						<td><span> </span><a class="lbl">運費計算</a></td>
						<td><select id="cmbGuild" class="txt c1"> </select></td>
					</tr>
					<tr>
